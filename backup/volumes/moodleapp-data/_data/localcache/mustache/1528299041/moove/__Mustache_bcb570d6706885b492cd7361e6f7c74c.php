...
class __Mustache_bcb570d6706885b492cd7361e6f7c74c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'togglecontent' => array($this, 'block09a422ca9b21f82e88140c45eb01c5ce'),
                ...
                'headeractions' => array($this, 'block86805b2802fa93f64102d5cb0ceaffd3'),
...
';
    ...
    public function block09a422ca9b21f82e88140c45eb01c5ce($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <i class="icon-bell" title="';
        // 'str' section
        $value = $context->find('str');
...
';
    ...
    public function blockF558de563850be3d6e147430d1c47e21($context)
    {
        $indent = $buffer = '';
...
';
    ...
    public function block2410dc7a5ed576adf8a6896f5247a3cc($context)
    {
        $indent = $buffer = '';
        $buffer .= '                <a href="';
...
';
    ...
    public function block86805b2802fa93f64102d5cb0ceaffd3($context)
    {
        $indent = $buffer = '';
        $buffer .= '        ';
        if ($parent = $this->mustache->loadPartial('core/hover_tooltip')) {
            $context->pushBlockContext(array(
                'anchor' => array($this, 'blockF558de563850be3d6e147430d1c47e21'),
        ...
        if ($parent = $this->mustache->loadPartial('core/hover_tooltip')) {
            $context->pushBlockContext(array(
                'anchor' => array($this, 'block2410dc7a5ed576adf8a6896f5247a3cc'),
