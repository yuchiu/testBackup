...
class __Mustache_d0319fe07306c6e54c47d3325a5c92f9 extends Mustache_Template
{
...
';
        $buffer .= $indent . '              <i class="icon-drawer"></i>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '          </div>
...
';
        $buffer .= $indent . '            <div class="icon">
';
        $buffer .= $indent . '              <i class="icon-people"></i>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '          </div>
...
';
        $buffer .= $indent . '            <div class="icon">
';
        $buffer .= $indent . '              <i class="icon-graduation"></i>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '          </div>
