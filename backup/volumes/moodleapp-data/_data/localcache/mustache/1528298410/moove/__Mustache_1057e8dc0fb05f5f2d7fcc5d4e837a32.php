...
class __Mustache_1057e8dc0fb05f5f2d7fcc5d4e837a32 extends Mustache_Template
{
...
';
        // 'hasidentityproviders' section
        $value = $context->find('hasidentityproviders');
        $buffer .= $this->sectionFc9247c93db48d48954251f384feb2ec($context, $indent, $value);
        $buffer .= $indent . '
';
        // 'js' section
...
';
    ...
    private function sectionFf55a8bc3ceef2d6ecfa0f7c8b9d358f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionFc9247c93db48d48954251f384feb2ec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                // 'hasinstructions' section
                $value = $context->find('hasinstructions');
                $buffer .= $this->sectionFf55a8bc3ceef2d6ecfa0f7c8b9d358f($context, $indent, $value);
                $context->pop();
            }
        }
