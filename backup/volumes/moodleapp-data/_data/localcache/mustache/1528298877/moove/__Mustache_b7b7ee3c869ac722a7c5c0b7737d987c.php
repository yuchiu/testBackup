...
class __Mustache_b7b7ee3c869ac722a7c5c0b7737d987c extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1f285c352294c719392f034d736f8944($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
            ...
            $buffer .= $indent . '                    </div>
';
            $buffer .= $indent . '                    <div class="col-12 col-sm-12 col-md-5 card" id="boxForm">
';
...
';
    ...
    private function sectionA295de04e8d664397cce362108c4bf68(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1f285c352294c719392f034d736f8944(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionA295de04e8d664397cce362108c4bf68($context, $indent, $value);
                $context->pop();
            }
        }
